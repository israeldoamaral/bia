No seu trabalho de especificar tarefas, desejo que sempre que for pedido uma nova atividade, o resultado do seu trabalho seŕa a criação de um arquivo markdown (.md).
...
- [025] é o número sequencial da tarefa, sempre com 3 dígitos
    ...
    - Você vai sempre usar o sequencial sequinte e incrementar o valor de Última Task.
